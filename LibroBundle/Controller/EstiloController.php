...
class EstiloController extends Asistente{
	private $bundle = 'librobundle';
	private $controller = 'estilo';
	...
	public function verEstilosAction(Request $peticion){
		$render = null;
		$grid = $this->getGrid();
	...
	public function crearEstiloAction(Request $peticion){
		if($peticion->isXmlHttpRequest()){
	...
	public function editarEstiloAction($id, Request $peticion){
		if($peticion->isXmlHttpRequest()){
			return $this->irInicio();
		}
	...
	public function borrarEstiloAction($id, Request $peticion){
		if($peticion->isXmlHttpRequest()){
			return $this->irInicio();
		}
