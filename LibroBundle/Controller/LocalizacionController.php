...
class LocalizacionController extends Asistente{
	private $bundle = 'librobundle';
	private $controller = 'localizacion';
	...
	public function verLocalizacionesAction(Request $peticion){
		$render = null;
		$grid = $this->getGrid();
	...
	public function crearLocalizacionAction(Request $peticion){
		if($peticion->isXmlHttpRequest()){
	...
	public function editarLocalizacionAction($id, Request $peticion){
		if($peticion->isXmlHttpRequest()){
			return $this->irInicio();
		}
	...
	public function borrarLocalizacionAction($id, Request $peticion){
		if($peticion->isXmlHttpRequest()){
			return $this->irInicio();
		}
