...
class DistribuidoraController extends Asistente{
	private $bundle = 'suministrobundle';
	private $controller = 'distribuidora';
	...
	public function verDistribuidorasAction(Request $peticion){
		$render = null;
		$grid = $this->getGrid();
	...
	public function crearDistribuidoraAction(Request $peticion){
		if($peticion->isXmlHttpRequest()){
	...
	public function editarDistribuidoraAction($id, Request $peticion){
		if($peticion->isXmlHttpRequest()){
			return $this->irInicio();
		}
	...
	public function borrarDistribuidoraAction($id, Request $peticion){
		if($peticion->isXmlHttpRequest()){
			return $this->irInicio();
		}
